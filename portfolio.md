...
> "Glycemic Increment (G+) directly estimates the blood sugar consequences of particular foods and composite meals (glycemic response). It provides an individualized model of each patient's response to particular foods. The inputs to the model are just a list of foods in a particular meal. The output is a number that directly estimates an increase or decrease in blood sugar over a reasonable period." (Balasi & Yarroll, 2025)

Unlike GI/GL, Glycemic Increment:
- Uses actual Continuous Glucose Monitor (CGM) data from the individual patient
- Does not require fasting states or precise food measurements
- Accounts for the patient's "typical serving" of each food
- Models the combined effects of foods eaten together
